    ...
    def set(self):
        ...
        for i in range(2 * (n-1)):
            self.parameters.append(
                {'name': 'I_{}'.format(i), 'bounds': [0, 2], 'parameter_type': 'float', 'initial_value': 1})
            self.parameters.append(
...
problem.antenna.save_array_factor('./results/array_factor_NSGA_II_coef.txt')
x = []
...
file = open('./results/convergence_NSGA_II_coef.txt', 'w')
