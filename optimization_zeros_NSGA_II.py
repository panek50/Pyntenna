...
class AntennaArrayProblem(Problem):
    ...
    def evaluate(self, individual):
        ...
        return [magnitude_r, np.std(np.abs(excitation))]
...
problem.antenna.save_array_factor('./results/array_factor_NSGA_II_zeros.txt')
...
file = open('./results/convergence_NSGA_II_zeros_.txt', 'w')
